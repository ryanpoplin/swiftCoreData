...
class ViewController: UIViewController, UITextViewDelegate, AVSpeechSynthesizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        saveShortcutButton.frame = CGRect(x: 5, y: buttonY, width: buttonWidth, height: buttonHeight)
        ...
        clearTextButton.frame = CGRect(x: 180, y: buttonY, width: buttonWidth, height: buttonHeight)
        ...
        shortcutsButton.frame = CGRect(x: 75, y: buttonY, width: 100, height: buttonHeight)
